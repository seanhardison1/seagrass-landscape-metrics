...
```{r, out.width = "60%"}
knitr::include_graphics(here::here("images/mvnorm.png"))
```
...
```{r, out.width = "60%"}
knitr::include_graphics(here::here("images/mvnorm2.png"))
```
...
```{r}
knitr::include_graphics(here::here("images/variogram_functions.png"))
```
...
```{r, out.width="50%"}
knitr::include_graphics(here::here("images/exp_corr_mat.png"))
```
